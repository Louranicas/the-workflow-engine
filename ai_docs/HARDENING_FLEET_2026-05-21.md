...
| W4 | `cargo-mutants` scoped to m10/m11/m21/m22. **Post-remediation verified run** (S1003733, frozen tree @ `0cc7be3`, 4 h): **324 mutants — 254 caught / 15 missed / 0 timeout / 55 unviable → 94.4 % kill rate** (254 of 269 viable). The S1003733 Wave-D+ iteration-cap fix **eliminated all 20 prior m21 `build_variants` timeout mutants** (now scored; 0 timeout). 15 survivors remain — 9 m21 `build_variants`, 5 m22 `kmeans_plus_plus_seed`, 1 m11 `consolidation` — documented here, NOT over-claimed; a focused mutant-kill pass is the recommended next step. *(Prior wording — "412 mutants, 80.6 %, every surviving non-timeout mutant resolved" — did not reconcile with any committed artifact; corrected + independently re-verified S1003733.)* | `5de71ac` + `0cc7be3` | → 1921 |
