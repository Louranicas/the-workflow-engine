...
- **DX-W3.src** ✅ **`variant.mutation` count.** Cost metric `step-count × variant.mutation`. Existing primitive (m21 `WorkflowVariant.mutation` integer); simplest. No new code; plan-floor W3 estimate stands (~150-250 LOC).
